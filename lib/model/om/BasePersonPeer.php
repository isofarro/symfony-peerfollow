...
abstract class BasePersonPeer {
	...
	/** the column name for the NO_FOLLOWERS field */
	const NO_FOLLOWERS = 'person.NO_FOLLOWERS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Bio', 'Image', 'NoFollowers', 'Fullname', 'Website', 'Status', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'bio', 'image', 'noFollowers', 'fullname', 'website', 'status', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::BIO, self::IMAGE, self::NO_FOLLOWERS, self::FULLNAME, self::WEBSITE, self::STATUS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'bio', 'image', 'no_followers', 'fullname', 'website', 'status', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Bio' => 2, 'Image' => 3, 'NoFollowers' => 4, 'Fullname' => 5, 'Website' => 6, 'Status' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'bio' => 2, 'image' => 3, 'noFollowers' => 4, 'fullname' => 5, 'website' => 6, 'status' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::BIO => 2, self::IMAGE => 3, self::NO_FOLLOWERS => 4, self::FULLNAME => 5, self::WEBSITE => 6, self::STATUS => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'bio' => 2, 'image' => 3, 'no_followers' => 4, 'fullname' => 5, 'website' => 6, 'status' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PersonPeer::BIO);

		$criteria->addSelectColumn(PersonPeer::IMAGE);

		$criteria->addSelectColumn(PersonPeer::NO_FOLLOWERS);

		$criteria->addSelectColumn(PersonPeer::FULLNAME);

		$criteria->addSelectColumn(PersonPeer::WEBSITE);

		$criteria->addSelectColumn(PersonPeer::STATUS);
