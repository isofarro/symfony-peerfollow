...
abstract class BasePersonPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Bio', 'Image', 'NoFollowers', 'Fullname', 'Website', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'bio', 'image', 'noFollowers', 'fullname', 'website', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::BIO, self::IMAGE, self::NO_FOLLOWERS, self::FULLNAME, self::WEBSITE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'bio', 'image', 'no_followers', 'fullname', 'website', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Bio' => 2, 'Image' => 3, 'NoFollowers' => 4, 'Fullname' => 5, 'Website' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'bio' => 2, 'image' => 3, 'noFollowers' => 4, 'fullname' => 5, 'website' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::BIO => 2, self::IMAGE => 3, self::NO_FOLLOWERS => 4, self::FULLNAME => 5, self::WEBSITE => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'bio' => 2, 'image' => 3, 'no_followers' => 4, 'fullname' => 5, 'website' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
