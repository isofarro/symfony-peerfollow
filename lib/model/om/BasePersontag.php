...
/**
 * Base class that represents a row from the 'personTag' table.
 *
 * 
 *
 ...
 */
abstract class BasePersontag extends BaseObject  implements Persistent {


  const PEER = 'PersontagPeer';
	...
	/**
	 * Initializes internal state of BasePersontag object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Persontag The current object (for fluent API support)
	 */
	public function setPersonId($v)
	{
		...
		if ($this->person_id !== $v) {
			$this->person_id = $v;
			$this->modifiedColumns[] = PersontagPeer::PERSON_ID;
		}
	...
	public function setTagId($v)
	{
		...
		if ($this->tag_id !== $v) {
			$this->tag_id = $v;
			$this->modifiedColumns[] = PersontagPeer::TAG_ID;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PersontagPeer::ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = PersontagPeer::NUM_COLUMNS - PersontagPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Persontag object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PersontagPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BasePersontag:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			PersontagPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BasePersontag:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasePersontag:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BasePersontag:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			PersontagPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PersontagPeer::doInsert($this, $con);
					...
					$affectedRows += PersontagPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PersontagPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PersontagPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PersontagPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PersontagPeer::PERSON_ID)) $criteria->add(PersontagPeer::PERSON_ID, $this->person_id);
		if ($this->isColumnModified(PersontagPeer::TAG_ID)) $criteria->add(PersontagPeer::TAG_ID, $this->tag_id);
		if ($this->isColumnModified(PersontagPeer::ID)) $criteria->add(PersontagPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PersontagPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Persontag (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Persontag Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PersontagPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PersontagPeer();
		}
		return self::$peer;
	}
	...
	public function getPerson(PropelPDO $con = null)
	{
		if ($this->aPerson === null && ($this->person_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPerson->addPersontags($this);
			 */
		}
		return $this->aPerson;
	}
  ...
  {
    if (!$callable = sfMixer::getCallable('BasePersontag:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BasePersontag::%s', $method));
    }
